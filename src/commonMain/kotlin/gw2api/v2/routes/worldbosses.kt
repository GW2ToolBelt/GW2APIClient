...
/**
 * Queries the `/v2/worldbosses` endpoint.
 *
 * ## The /v2/worldbosses endpoint
 *
 * > This resource returns information about the world bosses that can be slain once per day.
 *
 * ```
 * Paginated:           No
 * Bulk expanded:       No
 ...
 */
@GW2APIv2DataIds("worldbosses")
fun gw2v2WorldBosses(): RequestBuilder<Collection<String>> = query(
    endpoint = "/v2/worldbosses",
