...
/**
 * Queries the `/v2/account/luck` endpoint.
 *
 * ## The /v2/account/luck endpoint
 *
 * > This resource returns the total amount of luck unlocked by an account. This endpoint is only accessible with a
 * valid API key.
 *
 * ```
 * Paginated:           No
 ...
 */
@GW2APIv2Data("account/luck")
fun gw2v2AccountLuck(): RequestBuilder<Collection<GW2v2AccountLuck>> = query(
